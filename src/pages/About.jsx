...
const About = () => {
  ...
  const values = [
    {
      ...
      description:
        "Every product is made with love and dedication, preserving traditional techniques passed down through generations.",
    ...
    },
    {
      ...
      description:
        "We maintain the highest standards in materials and craftsmanship, ensuring each piece is built to last.",
    ...
    },
    {
      ...
      description:
        "We work directly with artisans, providing fair wages and supporting local communities worldwide.",
    ...
    },
    {
      ...
      description:
        "Our commitment to eco-friendly materials and processes helps preserve our planet for future generations.",
      color: "text-brand-orange",
    },
  ];
  ...
  const milestones = [
    {
      year: "2018",
      event: "COZ CASTLE Founded",
      description:
        "Started with a vision to connect artisans with design lovers",
    },
    {
      year: "2019",
      event: "First 100 Artisans",
      description: "Built partnerships with castlepeople across 5 countries",
    },
    {
      year: "2021",
    ...
    },
    {
      ...
      description: "Reached our milestone of serving 10,000 happy customers",
    },
    {
      year: "2024",
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="section-subtitle max-w-3xl mx-auto">
              We're more than a marketplace - we're a{" "}
              <span className="text-black font-semibold">bridge</span>{" "}
              connecting skilled{" "}
              <span className="text-black font-semibold">artisans</span> with
              people who appreciate authentic, handcrafted{" "}
              <span className="text-black font-semibold">beauty</span> in their
              homes.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  COZ CASTLE was born from a simple observation: in our
                  increasingly digital world, people crave authentic, tangible
                  connections to traditional craftsmanship. Our founder, Sarah
                  Johnson, discovered this during her travels through Southeast
                  Asia, where she witnessed incredible artisans creating
                  beautiful pieces that rarely reached global markets.
                </p>
                <p>
                  What started as a small collection of handwoven bags has grown
                  into a curated marketplace featuring hundreds of unique
                  products from artisans across the globe. Each piece in our
                  collection is chosen not just for its beauty, but for the
                  story it tells and the traditional techniques it preserves.
                </p>
                <p>
                  Today, we're proud to support over 300 artisans from 15
                  countries, helping preserve traditional castles while
                  providing sustainable livelihoods for skilled castlepeople.
                  Every purchase you make helps keep these time-honored
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              artisans to delivering products to your door.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`inline-flex p-4 rounded-full bg-white shadow-lg ${value.color} mb-6`}
                  >
                    <Icon size={32} />
                  </div>
      ...
      {/* <section className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From a small startup to a global marketplace, here's how we've
              grown while staying true to our mission.
            </p>
          </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Every purchase supports artisan communities and helps preserve
              traditional castles. Discover unique pieces that tell a story.
            </p>
